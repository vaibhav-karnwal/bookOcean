    ...
    return(
        <section className='text-center'>
            ...
            <form style={{"margin":"0 auto"}}  className='w-25 gap-2 card p-2 d-flex flex-column align-items-center my-2'>
                <input type="text" id="name" value = {employee.userName} onChange={userNameHandler} className="fadeIn first" name="login" placeholder="Full Name"/>
                ...
                <input type="submit" className="fadeIn fourth" onClick={addUser} value="Register"/>
            </form>
        </section>
    )
}
