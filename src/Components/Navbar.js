    ...
    return(
        <>
            <div className="d-flex justify-content-between container my-4 bg-secondary rounded">
                ...
                <input type="search" class="input-group rounded form-control rounded" onChange={(event)=>handler()}placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
