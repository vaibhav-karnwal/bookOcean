    ...
    return(
        <>
            ...
            <div className="box" style={{"marginBottom":"10%"}} >
                ...
                <div style={{"marginLeft":"40%","float":"left","height":"120px", "border-right": "3px solid grey"}}>     
                    <p/>
                </div>
                <div className="my-4 mx-2 p-1" style={{"float":"left","height":"120px", "border-right": "3px solid grey"}}> 
                    <p/>
                </div>
